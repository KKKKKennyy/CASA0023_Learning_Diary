# Week01 Introduction to remote sensing {.unnumbered}

## 1. Theoretical Part

![Mindmap for W1 lecture part](img/Week1Mindmap.png)
...
![Different Sensors](img/DifferentSensors.png)
Source: [NASA](https://www.earthdata.nasa.gov/learn/backgrounders/remote-sensing#resolution)
...
![Interaction with Earth's Surface](img/InteractionWithSurface.png) 
Source:[Ghimire, 2021](https://www.researchgate.net/publication/350978231_Remote_Sensing_and_Image_Analysis_in_Environmental_Studies/figures?lo=1)
...
![Interaction with Atmosphere](img/InteractionWithAtmosphere.png) 
Source:[Bovensmann et al., 2011](https://wordpress71133.wordpress.com/the-light-energy-source-in-remote-sensing/)
...
![Wavelength of Different colours](img/WavelengthOfColors.png) 
Source: [The University of Waikato Te Whare Wānanga o Waikato](https://www.sciencelearn.org.nz/resources/47-colours-of-light)
...
![The difference in pixel resolution](img/SpatialResolution.png)
Source: [NASA](https://www.earthdata.nasa.gov/learn/backgrounders/remote-sensing#resolution)
...
![Sprctral data storage](img/SpectralResoluton.png)
Source: [NIREOS](https://www.nireos.com/hyperspectral-imaging/)
...
![Satellites with different pixel resolution and update frequency](img/Temporal.png)
Source: [ESRI](https://www.esri.com/about/newsroom/arcuser/a-world-of-imagery-available-through-arcgis-online/)
